...
ROUTER_PD_DECODE_PREALLOC_SOFT_LIMIT="${ROUTER_PD_DECODE_PREALLOC_SOFT_LIMIT:-0}"
ROUTER_PD_DECODE_OLDEST_PREALLOC_WAIT_MS_SOFT_LIMIT="${ROUTER_PD_DECODE_OLDEST_PREALLOC_WAIT_MS_SOFT_LIMIT:-0}"
ROUTER_PD_ADMISSION_POLL_MS="${ROUTER_PD_ADMISSION_POLL_MS:-50}"
...
render() {
  sed \
    ...
    -e "s|<ROUTER_PD_DECODE_PREALLOC_SOFT_LIMIT>|$(escape_sed "$ROUTER_PD_DECODE_PREALLOC_SOFT_LIMIT")|g" \
    -e "s|<ROUTER_PD_DECODE_OLDEST_PREALLOC_WAIT_MS_SOFT_LIMIT>|$(escape_sed "$ROUTER_PD_DECODE_OLDEST_PREALLOC_WAIT_MS_SOFT_LIMIT")|g" \
    -e "s|<ROUTER_PD_ADMISSION_POLL_MS>|$(escape_sed "$ROUTER_PD_ADMISSION_POLL_MS")|g" \
