...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, ...]]] = {
    "TPU v7": {
        ...
        # Decode configs (tuned 2026-05-23 with DAQ + x_s deferral)
        ('bfloat16', 'float8_e4m3fn', 64, 384, 8, 6144, 2048, 32, False, False): (8, 512, 8, 256, 8),
        ('bfloat16', 'float8_e4m3fn', 128, 384, 8, 6144, 2048, 32, False, False): (8, 512, 16, 256, 16),
        ...
        ('bfloat16', 'float8_e4m3fn', 1024, 384, 8, 6144, 2048, 32, False, False): (32, 1024, 32, 256, 32),
        # Prefill configs (tuned 2026-05-23 with DAQ + x_s deferral)
