...
class FusedEPMoE(nnx.Module):
    ...
    def __init__(
        ...
        self.disable_a2a_scatter_local_copy = disable_a2a_scatter_local_copy
        self.disable_a2a_scatter_remote_copy = disable_a2a_scatter_remote_copy
        self.disable_a2a_scatter_recv_wait = disable_a2a_scatter_recv_wait
        self.disable_a2a_scatter_send_wait = disable_a2a_scatter_send_wait
        self.disable_a2a_gather = disable_a2a_gather
        self.disable_a2a_gather_local_copy = disable_a2a_gather_local_copy
        self.disable_a2a_gather_remote_copy = disable_a2a_gather_remote_copy
        self.disable_w1_load = disable_w1_load
        self.disable_w3_load = disable_w3_load
        self.disable_w2_load = disable_w2_load
        self.disable_w1_scale_load = disable_w1_scale_load
        self.disable_w3_scale_load = disable_w3_scale_load
        self.disable_w2_scale_load = disable_w2_scale_load
        self.disable_w1_scale_apply = disable_w1_scale_apply
        ...
        self.disable_expert_store_dma = disable_expert_store_dma
        self.disable_expert_store_wait = disable_expert_store_wait
        self.disable_acc_and_store = disable_acc_and_store
        self.disable_acc_load = disable_acc_load
    ...
    def __call__(
        ...
        *,
        ...
        output = fused_ep_moe_v2(
            ...
            disable_a2a_scatter_local_copy=self.disable_a2a_scatter_local_copy,
            disable_a2a_scatter_remote_copy=self.disable_a2a_scatter_remote_copy,
            disable_a2a_scatter_recv_wait=self.disable_a2a_scatter_recv_wait,
            disable_a2a_scatter_send_wait=self.disable_a2a_scatter_send_wait,
            disable_a2a_gather=self.disable_a2a_gather,
            disable_a2a_gather_local_copy=self.disable_a2a_gather_local_copy,
            disable_a2a_gather_remote_copy=self.disable_a2a_gather_remote_copy,
            disable_dynamic_ffn1=self.disable_dynamic_ffn1,
            disable_dynamic_ffn2=self.disable_dynamic_ffn2,
            disable_weight_load=self.disable_weight_load,
            disable_w1_load=self.disable_w1_load,
            disable_w3_load=self.disable_w3_load,
            disable_w2_load=self.disable_w2_load,
            disable_w1_scale_load=self.disable_w1_scale_load,
            disable_w3_scale_load=self.disable_w3_scale_load,
            disable_w2_scale_load=self.disable_w2_scale_load,
            disable_w1_scale_apply=self.disable_w1_scale_apply,
            ...
            disable_expert_store_dma=self.disable_expert_store_dma,
            disable_expert_store_wait=self.disable_expert_store_wait,
            disable_acc_and_store=self.disable_acc_and_store,
            disable_acc_load=self.disable_acc_load,
