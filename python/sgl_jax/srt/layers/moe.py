...
def create_moe_weights_mapping(
    ...
    if moe_backend == "epmoe":
        ...
        # fused_v4 (TP-MoE) loads weights in the same EP-sharded layout as
        # FusedEPMoE and reshards to TP in the model's _post_load_weights hook.
        expert_type_map = {
    ...
    for source_name, target_name in expert_type_map.items():
        ...
        if moe_backend == "epmoe":
            ...
            # FUSED_V4 reshards to TP layout after load (see
            # FusedTPMoEV4.reshape_weights_for_tp).
